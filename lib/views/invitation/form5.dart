...
class FormInvitation5 extends StatefulWidget {
  const FormInvitation5({Key? key}) : super(key: key);
...
class _FormInvitation5State extends State<FormInvitation5> {
  ...
  Widget build(BuildContext context) {
    ...
    final package = _package[idPackage-1];
    final price = package['price'];


    final idTheme = formData.idTheme;
    // final theme = _theme[idTheme-1];
    final theme = (idTheme > 0 && idTheme <= _theme.length) ? _theme[idTheme - 1] : null;
            ...
            child: Container(
                ...
                child: SafeArea(
                  child: Column(
                      ...
                      children: [
                        const ButtonClose(text: "Langkah 5 dari 5", currentStep: 5),
                        Text(
                          "Pembayaran",
                          style: TextStyle(
                                ...
                                Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        image != null
                                        ? Image.file(
                                          image):Image.asset('assets/images/theme.png'),
                                        const SizedBox(height: 15),
                                        Container(
                                            padding:
